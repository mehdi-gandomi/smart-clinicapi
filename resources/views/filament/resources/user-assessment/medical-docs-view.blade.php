@php
    $medicalDocs = $getRecord()->medicalDocuments()->get();
@endphp
...
<div class="space-y-4">
    @if($medicalDocs->count() > 0)
        ...
        <h4 class="text-lg text-black mb-3">{{ \Str::title(str_replace('_', ' ', $doc->doc_type)) }}</h4>
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    @foreach($doc->files as $index => $file)
                        <a
                            ...
                            data-gallery="medical-gallery-{{$doc->id}}"
